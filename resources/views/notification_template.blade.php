<div dir="rtl"
    ...
    <div class="row mx-0  ">
        <div class="col" onclick="location.href='<?php echo backpack_url('notification/'.$notification->id) ;?>'">
        ...
        <div class="col-2 justify-content-center align-items-center d-flex">
            @if($notification->read_at == null)
                <div title='تمييز كمقروء'
                     ...
                     onclick='{$.get("<?php echo backpack_url("read_notification/$notification->id") ;?>").then(data => {
                         if(data){
                         $(this).hide()
