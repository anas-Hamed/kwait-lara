...
class CompanyDisabledNotificationForUser extends Notification
{
    use Queueable;
    ...
    public function toArray($notifiable)
    {
        return [
            'id' => $this->company->id,
            'title' => 'تعطيل شركة',
            'body' => sprintf('تم تعطيل  الشركة %s الخاصة بك',$this->company->ar_name),
            'type' => get_class($this),
        ];
    }
        ...
        return FcmMessage::create()
            ...
            ->setAndroid(
                AndroidConfig::create()
                    ->setFcmOptions(AndroidFcmOptions::create()->setAnalyticsLabel('CompanyDisabledNotificationForUser'))
            ...
            ->setApns(ApnsConfig::create()->setPayload(['aps' => ['sound' => 'default']])
                ->setFcmOptions(ApnsFcmOptions::create()
                    ->setAnalyticsLabel('CompanyDisabledNotificationForUser')));
    }
}
