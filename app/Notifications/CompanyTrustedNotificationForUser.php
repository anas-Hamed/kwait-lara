...
class CompanyTrustedNotificationForUser extends Notification
{
    use Queueable;
    protected $company;
    ...
    public function toArray($notifiable)
    {
        return [
            'id' => $this->company->id,
            'title' => 'الموافقة على توثيق الشركة',
            'body' => sprintf('تمت الموافقة على توثيق الشركة %s الخاصة بك',$this->company->ar_name),
            'type' => get_class($this),
        ];
    }
        ...
        return FcmMessage::create()
            ...
            ->setAndroid(
                AndroidConfig::create()
                    ->setFcmOptions(AndroidFcmOptions::create()->setAnalyticsLabel('CompanyTrustedNotificationForUser'))
            ...
            ->setApns(ApnsConfig::create()->setPayload(['aps' => ['sound' => 'default']])
                ->setFcmOptions(ApnsFcmOptions::create()
                    ->setAnalyticsLabel('CompanyTrustedNotificationForUser')));
    }
}
